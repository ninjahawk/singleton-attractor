...
Appendix~\ref{sec:cosmology} contains speculative cosmological implications
(not a formal result; moved from main body).
...
These observations are offered as motivating context only.
