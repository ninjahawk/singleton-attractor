...
falsifiable hypothesis on six concrete proxies (frontier training
compute and five public benchmarks).
On none of the six is the curvature significantly positive; on two
benchmarks it is significantly negative; the full deep-learning window
of frontier compute is consistent with pure exponential growth.
This does not refute A4---each proxy is a partial slice of capability,
and the data are silent on the future---but it does shift the burden
onto proponents of the singleton scenario to specify which capability
proxy they expect to enter the $\beta < 0$ regime, and on what
timescale.
