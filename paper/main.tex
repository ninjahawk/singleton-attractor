...
The winner-randomization threshold $\sigma \approx 0.23$ is an empirical
observation from simulation, not analytically derived.
Feller's criterion proves singleton formation at all $\sigma > 0$ but does
not bound the noise amplitude at which initial-leader identity becomes
unreliable; that threshold depends on the initial capability gap and is a
function of the ratio $\sigma / \mathrm{gap}$.
